...
\begin{table}[!hb]
  ...
  \begin{tabular}{
  		| >{\sffamily\raggedright}p{2.0cm}
  		| >{\sffamily}p{\dimexpr\textwidth-6\tabcolsep-0\fboxsep-4.5cm\relax} |
  	}
  	\hline
  	\rowcolor{gray!20}\multicolumn{1}{|c|}{\bfseries\sffamily Moxa NPort 5610 (ics-moxabox-01)} 
  	& \multicolumn{1}{c|}{\bfseries\sffamily IFC1211} \\
  	\hline
  	\begin{tabular}[t]{

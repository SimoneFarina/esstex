...
\item VME-EVR-300
\end{itemize}
And this document covers only PCIe-EVR-300DC. 
\section{PCIe-EVR-300DC}
\begin{figure}[!htb]
  \centering
  \includegraphics[width=0.8\textwidth]{./pictures/pcie_evr_300dc.eps}
  \caption{
...
\section{Hardware list and specification}
